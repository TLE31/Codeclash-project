    ...
    <div className="profile">
      ...
      <div className="profile-content">
        ...
        <div className="profile-content-details">
          ...
          <h1 style={{ color: "#000" }}>{viewUser ? viewUser.name : ""}</h1>
      ...
      <center style={{ color: "#000"}}>
        ...
        (viewUser ? viewUser._id : "") ? (
          alreadyFriend ? (
            ...
            <button onClick={makeFriend} style={{ backgroundColor: "#007bff", color: "#fff", padding: "10px 20px", borderRadius: "5px", border: "none", cursor: "pointer" }}>
              Make Connection
            </button>
          )
        ) : (
